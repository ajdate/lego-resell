...
> = {
  imminent: {
    title: "Critical — Retiring in 1–2 Months",
    setNumbers: [
      "42143",
      "42151",
      "42161",
    ...
    monthsLabel: "~1–2 months remaining",
    urgencyBarPercent: 92,
    borderClass: "border-l-red-500",
    barClass: "bg-red-500",
    badgeClass: "bg-red-500/20 text-red-400 border-red-500/30",
    timingAdvice:
      "🔴 Act Now — retirement expected within 1–2 months. Buy sealed sets while still available at retail.",
  },
  soon: {
    title: "High — Retiring in ~6 Months",
    setNumbers: [
      "75192",
      "10309",
      "10318",
    ...
    monthsLabel: "~6 months remaining",
    urgencyBarPercent: 65,
    borderClass: "border-l-[#f59e0b]",
    barClass: "bg-[#f59e0b]",
    badgeClass: "bg-[#f59e0b]/20 text-[#fbbf24] border-[#f59e0b]/30",
    timingAdvice:
      "🟡 Plan Your Move — retirement expected in ~6 months. Start monitoring stock levels and secondary market prices.",
  },
  upcoming: {
    title: "Upcoming — 6 to 12 Months",
    setNumbers: ["21335", "10290", "10303", "75331"],
